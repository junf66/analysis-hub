...
def main() -> None:
    ...
    ap.add_argument("--year", type=int, help="event_date の年で絞り込み (e.g. 2025)")
    ...
    ap.add_argument("--histogram-bins", type=int, default=20, help="histogram の bin 数 (既定 20)")
    ap.add_argument("--bootstrap", action="store_true", help="平均の bootstrap 95%% CI")
    ap.add_argument("--bootstrap-iter", type=int, default=2000, help="bootstrap リサンプル回数 (既定 2000)")
