...
def main() -> None:
    ...
    print(f"[margin_signal] threshold {args.threshold:+.0f}% → {len(events)}件 / {ncodes}銘柄 enrich開始")
    ...
    enrich_events_by_code(events, DAYS, skip_bars=PUBLISH_SKIP, on_checkpoint=_ckpt)
