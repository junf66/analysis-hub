...
| `kouhou_genshu` | **業績上方修正 + 減益決算** (Phase 1.5 で追加) | 好: `EarnForecastRevision` (NP+3% 超) / 悪: 決算短信 (NP YoY -10% 未満) |
| `kouhou_kahou` | **業績上方修正 + 業績下方修正** (Phase 1.5 で追加) | 同日に上方と下方が同居 (e.g. 配当上方 + 業績下方) |
| `other` | 上記いずれにも当てはまらない | 残余 (現状 10 件) |
