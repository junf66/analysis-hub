...
現在【FDR確定8本】: **②③④⑤①B⑥⑦⑧**。加えて **①A は裁量採用枠**（2026-06-08・FDR未通過の別ティア・要監視。≥1兆×GD×9:05-9:10限定）。各エッジの方向/条件/売買時刻/成績/効きどころは `docs/edge_playbook.md` に集約。共有用1枚は `docs/edge_summary_share.md`。
